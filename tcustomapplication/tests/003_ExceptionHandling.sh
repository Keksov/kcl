...
kk_test_section "003: TCustomApplication Exception Handling"

# Test: HandleException with Exception object
kk_test_start "HandleException with Exception object"
...
result=$?
if [[ $result -eq 0 ]]; then
    kk_test_pass "HandleException with Exception object completed"
else
    kk_test_fail "HandleException with Exception object failed"
fi
myapp.delete

# Test: HandleException with non-Exception object
kk_test_start "HandleException with non-Exception object"
TCustomApplication.new myapp
myapp.HandleException "mock_sender" "not_an_exception_object"
result=$?
if [[ $result -eq 0 ]]; then
    kk_test_pass "HandleException with non-Exception handled default case"
else
    kk_test_fail "HandleException with non-Exception failed"
fi
myapp.delete

# Test: HandleException with OnException handler set
kk_test_start "HandleException with OnException handler"
TCustomApplication.new myapp
...
kk_test_start "HandleException triggering termination"
TCustomApplication.new myapp
...
if [[ "$terminated_before" == "false" && "$terminated_after" == "true" ]]; then
    kk_test_pass "HandleException triggered termination as expected"
else
...
kk_test_start "ShowException method"
TCustomApplication.new myapp
myapp.ShowException "Test exception message"
result=$?
if [[ $result -eq 0 ]]; then
    kk_test_pass "ShowException method completed"
else
    kk_test_fail "ShowException method failed"
fi
myapp.delete

# Test: ShowException with empty message
kk_test_start "ShowException with empty message"
TCustomApplication.new myapp
myapp.ShowException ""
result=$?
if [[ $result -eq 0 ]]; then
    kk_test_pass "ShowException with empty message completed"
else
    kk_test_fail "ShowException with empty message failed"
fi
myapp.delete

# Test: ShowException with long message
kk_test_start "ShowException with long message"
TCustomApplication.new myapp
...
result=$?
if [[ $result -eq 0 ]]; then
    kk_test_pass "ShowException with long message completed"
else
    kk_test_fail "ShowException with long message failed"
fi
myapp.delete

# Test: HandleException called multiple times
kk_test_start "Multiple HandleException calls"
TCustomApplication.new myapp
...
result=$?
if [[ $result -eq 0 ]]; then
    kk_test_pass "Multiple HandleException calls completed"
else
    kk_test_fail "Multiple HandleException calls failed"
fi
myapp.delete

kk_test_log "003_ExceptionHandling.sh completed"