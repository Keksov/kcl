...
kt_test_start "FindOptionIndex with short option"
...
kt_test_start "FindOptionIndex with long option"
TCustomApplication.new myapp
...
kt_test_start "FindOptionIndex with StartAt parameter"
TCustomApplication.new myapp
...
kt_test_start "GetOptionValue with long option"
TCustomApplication.new myapp
...
kt_test_start "HasOption finds short option"
TCustomApplication.new myapp
...
kt_test_start "HasOption returns false for non-existent option"
TCustomApplication.new myapp
myapp.SetArgs file.txt data.txt
myapp.HasOption "x" ""
result=$RESULT
...
kt_test_start "CheckOptions rejects invalid options"
TCustomApplication.new myapp
