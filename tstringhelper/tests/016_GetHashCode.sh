...
if [[ -n "$result" && "$result" =~ ^[0-9-]+$ ]]; then
    ...
    kt_test_fail "GetHashCode - basic hash (expected: integer, got: '$result')"
fi
...
if [[ -n "$result" && "$result" =~ ^[0-9-]+$ ]]; then
    ...
    kt_test_fail "GetHashCode - empty string (expected: integer, got: '$result')"
fi
...
if [[ -n "$result" && "$result" =~ ^[0-9-]+$ ]]; then
    ...
    kt_test_fail "GetHashCode - with spaces (expected: integer, got: '$result')"
fi
...
if [[ -n "$result" && "$result" =~ ^[0-9-]+$ ]]; then
    ...
    kt_test_fail "GetHashCode - numeric string (expected: integer, got: '$result')"
fi
...
if [[ -n "$result" && "$result" =~ ^[0-9-]+$ ]]; then
    ...
    kt_test_fail "GetHashCode - special characters (expected: integer, got: '$result')"
fi
...
if [[ -n "$result" && "$result" =~ ^[0-9-]+$ ]]; then
    ...
    kt_test_fail "GetHashCode - single character (expected: integer, got: '$result')"
fi
...
if [[ -n "$result" && "$result" =~ ^[0-9-]+$ ]]; then
    ...
    kt_test_fail "GetHashCode - long string (expected: integer, got: '$result')"
fi
