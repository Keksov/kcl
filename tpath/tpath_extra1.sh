#!/bin/bash
# kcl/tpath_extra.sh - Additional TPath methods to avoid eval size limits

# Source kklass system
SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
source "$SCRIPT_DIR/../../kklass/kklass.sh"

# Define additional TPath methods in separate class
defineClass "tpath_extra" "" \
...
echo "tpath_extra class created successfully"
