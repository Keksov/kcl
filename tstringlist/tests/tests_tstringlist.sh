#!/bin/bash
# test_tstringlist.sh - Comprehensive test suite for TStringList class
# Tests all TStringList functionality
...
run_tests() {
    ...
    if [[ "$VERBOSITY" == "info" ]]; then
        echo ""
        echo -e "${CYAN}========================================${NC}"
        echo -e "${CYAN}Comprehensive TStringList Test Suite${NC}"
        echo -e "${CYAN}========================================${NC}"
